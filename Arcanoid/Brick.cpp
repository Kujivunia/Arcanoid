...
void Brick::setBrickWide(int a) { brickWide = a; }
int Brick::getBrickWide() { return brickWide; }
void Brick::setOnScreen(bool a) { onScreen = a; }
bool Brick::getOnScreen() { return onScreen; }
